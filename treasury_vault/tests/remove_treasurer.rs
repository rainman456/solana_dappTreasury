...
#[tokio::test]
async fn remove_treasurer_ix_success() {
	...
	let (user_role_pda, _user_role_pda_bump) = Pubkey::find_program_address(
		&[
			b"role",
	...
	let ix = treasury_vault_ix_interface::remove_treasurer_ix_setup(
		treasury_pda,
		&admin_keypair,
		user_role_pda,
		user,
