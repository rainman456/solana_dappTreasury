...
#[tokio::test]
async fn schedule_payout_ix_success() {
	...
	let scheduled_time: i64 = Default::default();
	let recurring: bool = Default::default();
	let recurrence_interval = None;
	let recurrence_end_time = None;
	...
	let ix = treasury_vault_ix_interface::schedule_payout_ix_setup(
		treasury_pda,
		payout_pda,
		&authority_keypair,
